 ...
 *
 * <p>You don't need to care the order of combinations, but you should make sure the numbers in a
 * combination are sorted.
 *
 * <p>Have you met this question in a real interview? Example Given n = 4 and k = 2, a solution is:
 *
