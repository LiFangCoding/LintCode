 ...
 *
 * <p>It's guaranteed there is only one available solution
 *
...
public class _618 {
    ...
    private UndirectedGraphNode bfs(
            UndirectedGraphNode s, Map<UndirectedGraphNode, Integer> map, int target) {
